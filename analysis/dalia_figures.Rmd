...
fig_attitudes_services <- fnc_fig_attitudes("acceptability_service",
                                            "Acceptability of personalizing a service")

fig_attitudes_information <- fnc_fig_attitudes(
  "acceptability_information",
  "Acceptability of using information for personalization"
)

fig_attitudes_data <- fnc_fig_attitudes("acceptability_data",
                                        "Acceptability of collecting and using data")
...
fig_concern <-
  plot_grid(
    fig_concern +
      guides(fill = "none") +
      theme(plot.margin = margin(15, 0, 0, 75)),
    fig_concern_legend,
    labels = c("Privacy concerns"),
    hjust = -.25,
    ncol = 2,
    scale = c(1, .8),
    rel_heights = c(10, 1)
...
fig_privacy_tools_settings <- plot_grid(
  ...
  fig_privacy_settings +
    theme(legend.position = "none"),
  ncol = 1,
  labels = c(" Privacy tools", "Privacy settings"),
  hjust = -.25,
  axis = "b",
  align = "hv"
)
...
fig_political_attitudes <- dat_fig_political_attitudes %>%
  ...
  scale_fill_manual(values = c("red", "white", "darkgrey")) +
...
fig_political <- plot_grid(
  fig_political_attitudes +
    ggtitle("Attitudes towards personalization"),
  fig_concern_political,
  rel_widths = c(1, .7),
  nrow = 1
)
...
fig_used_applications <- fig_terminology_base %+%
  ...
  ggtitle("\"Which of the following applications have you used within the past year?\"")
...
fig_awareness <- fig_terminology_base %+%
  ...
  ggtitle("\"In which of the following situations do you think AI technologies are commonly used?\"")
...
fig_feed <- fig_terminology_base %+%
  ...
  ggtitle("\"What do you think are the main criteria used to customize which posts you see?\"")
